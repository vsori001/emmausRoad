...
add_action('dslc_hook_register_modules',
     create_function('', 'return dslc_register_module( "Slowave_Blog_Classic_Alt_Block" );')
);

class Slowave_Blog_Classic_Alt_Block extends DSLC_Module {
 		
 	// Module Attributes
    var $module_id = 'Slowave_Blog_Classic_Alt_Block';
    var $module_title = 'Blog Classic (Alt)';
    ...
    function output( $options ) {
    	...
    	if ( is_active_sidebar('primary') && $options['sidebar'] == 'yes' ){
	  	...
	  	if ( $block_query->have_posts() ) : while ( $block_query->have_posts() ) : $block_query->the_post();
	  		 ...
	  		 */
	  		get_template_part('loop/content', 'postfeedalt');
