...
add_action('dslc_hook_register_modules',
     create_function('', 'return dslc_register_module( "Slowave_Blog_Block" );')
);

class Slowave_Blog_Block extends DSLC_Module {
 		
 	// Module Attributes
    var $module_id = 'Slowave_Blog_Block';
    var $module_title = 'Blog Grid';
    var $module_icon = 'th';
    ...
    function output( $options ) {
		...
		//CONTENT START
		echo ( is_active_sidebar('primary') && $options['sidebar'] == 'yes' ) ? '<div class="row"><div class="col-sm-8 content"><div class="grid-blog col2">' : '<div class="grid-blog col3">';
